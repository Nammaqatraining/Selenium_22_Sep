...
public class Prog3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//button[contains(text(),'demonstrate the prompt box ')])[1]")).click();
		...
		Thread.sleep(5000);
		//To enter the text to alert box
		driver.switchTo().alert().sendKeys("This is My Text");
